...
let package = Package(
  ...
  products: [
    ...
    dependencies: [
        ...
        .package(name: "AlamofireImage", url: "https://github.com/Alamofire/AlamofireImage.git", from: "4.2.0")
    ],
  ...
  targets: [
    ...
    .target(name: "AlamofireImageBT", dependencies: ["AlamofireImage"]),
        ...
        .target(name: "AzupaySdkTargets",
                       dependencies: [
                           ...
                           .target(name: "AlamofireImageBT", condition: .when(platforms: .some([.iOS]))),
                       ],
